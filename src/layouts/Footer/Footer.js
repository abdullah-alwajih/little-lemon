    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-contact">
          ...
          <p className="footer-item"> KSA Riyadh</p>
          <p className="footer-item"> +966 500 608 507</p>
          <p className="footer-item"> little.lemon@lemon.com</p>
        </div>
        <div className="footer-social">
          <p className="footer-title"> SOCIAL MEDIA LINKS</p>
         
          <a className="footer-item" href="https://www.linkedin.com/in/abdullah-alwajih/" target="_blank"
             rel="noopener noreferrer">LinkedIn</a>
          <a className="footer-item" href="https://twitter.com/AlWajihAbdullah" target="_blank"
